%==========================================================================
  % Two dimensional heat transfer solver which accepts a mesh data file and
   % computes the simulated results
 %==========================================================================
function [coord, connect, T, R, q, x1, x2, x3, y1, y2, y3] = heat_2d_solver(fileID)
  %==========================================================================
